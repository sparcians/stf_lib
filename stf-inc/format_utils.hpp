...
namespace stf {
    ...
    class format_utils {
        ...
        public:
            ...
            static constexpr int MEM_ACCESS_FIELD_WIDTH = 8; /**< Total width of the MEM_ATTR field*/
            ...
            static constexpr int REGISTER_NAME_WIDTH = 17; /**< Width of the register name field*/
            static constexpr int EVENT_WIDTH = 28; /**< Width of an event code string representation */
