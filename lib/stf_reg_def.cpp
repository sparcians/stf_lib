...
namespace stf {
    void Registers::formatCSR(std::ostream& os, const Registers::STF_REG regno) {
        switch(regno) {
    ...
    void Registers::formatFPR(std::ostream& os, const Registers::STF_REG regno) {
    ...
    void Registers::formatGPR(std::ostream& os, const Registers::STF_REG regno) {
    ...
    std::ostream& operator<<(std::ostream& os, const Registers::STF_REG regno) {
        ...
        if (Registers::isFPR(regno)) {
            Registers::formatFPR(os, regno);
        }
        else if (Registers::isCSR(regno)) {
            Registers::formatCSR(os, regno);
        }
        else if (Registers::isGPR(regno)) {
            Registers::formatGPR(os, regno);
        }
        else {
